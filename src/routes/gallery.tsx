...
const vesu_mental_load1 = g("vesuvius_mental_load1.jpg");
const vesu_mental_load2 = g("vesuvius_mental_load2.jpg");
...
const initiativesEvents: Event[] = [
  ...
  },
  {
    ...
    title: "Transition into Adulthood",
    type: "Workshop",
    date: "17th-21st May 2026",
  ...
  },
  {
    ...
    subtitle: "An in-house seminar turning anxious thoughts into purposeful, grounded action",
...
const collaborationsEvents: Event[] = [
  {
    ...
    type: "Seminar",
    date: "20th June 2026",
    subtitle: "A dedicated seminar at CK Birla Hospitals CMRI celebrating and supporting fathers in their mental health journey",
    seeds: ["cmri-a", "cmri-b"],
    images: [cmri_father1, cmri_father2],
  },
  {
    id: "kolkata-debating-club",
    title: "Calcutta Debating Club",
    type: "Seminar",
    date: "3rd June 2026",
    subtitle: "A collaborative session with the Calcutta Debating Club exploring mental health through structured dialogue",
    seeds: ["kdc-a", "kdc-b"],
    images: [kdc1, kdc2],
  },
  {
    ...
    type: "Seminar",
    date: "26th May 2026",
    subtitle: "A workplace seminar for Vesuvius International Ltd. helping parents build resilience and connection at home",
  ...
  },
  {
    ...
    date: "8th May 2026",
    subtitle: "A community awareness program co-hosted with Brave Souls Foundation spotlighting mental health and wellbeing",
  ...
  },
  {
    ...
    type: "Seminar",
    date: "9th March 2026",
    subtitle: "A candid seminar at Vesuvius International Ltd. uncovering the hidden emotional labour carried at home and work",
    seeds: ["vesuvius2-a", "vesuvius2-b", "vesuvius2-c"],
    images: [vesu_mental_load, vesu_mental_load1, vesu_mental_load2],
  },
  {
    id: "iocl-mental-load",
    ...
    subtitle: "A seminar at IOCL Haldia Refinery addressing the unseen cognitive and emotional burdens employees carry daily",
  ...
  },
  {
    ...
    subtitle: "A specialised training at Calcutta University equipping PhD scholars to identify and support learning disabilities",
  ...
  },
  {
    ...
    subtitle: "A targeted training for Noah's Arc Foundation building emotional and cognitive skills in children with special needs",
    seeds: ["noah-a", "noah-b", "noah-c"],
    images: [noah_arc1, noah_arc2, noah_arc3],
  },
  {
    id: "walk-dyslexia",
    title: "Anjali Dyslexia Association",
    type: "Awareness Program",
    date: "29th October 2025",
    subtitle: "A public awareness walk with the Anjali Dyslexia Association advocating for dyslexia support and inclusion",
    seeds: ["dyslexia-a", "dyslexia-b", "dyslexia-c"],
    images: [walk1, walk2, walk3],
  },
  {
    id: "ntpc-womens-mental-health",
    title: "NTPC Farakka Women's Mental Health at Work",
    type: "Seminar",
    date: "8th March 2025",
    subtitle: "A women-focused mental health seminar at NTPC Farakka addressing unique workplace challenges and wellbeing strategies",
  ...
  },
  {
    ...
    subtitle: "A courageous panel with Brave Souls Foundation amplifying the voices and resilience of acid attack survivors",
  ...
  },
  {
    ...
    subtitle: "A practical stress management seminar delivered to TCS employees covering tools for a healthier work-life balance",
  ...
  },
  {
    ...
    subtitle: "A seminar at IOCL Haldia Refinery equipping employees with practical strategies to manage occupational stress",
  ...
  },
  {
    ...
    type: "Seminar",
    date: "27th June 2024",
    subtitle: "A mental health and wellbeing seminar hosted at IOCL ERPL fostering awareness and open conversations at work",
  ...
  },
  {
    ...
    type: "Seminar",
    date: "18th June 2024",
    subtitle: "A seminar at IOCL Eastern Region Office guiding employees toward sustainable mental wellbeing and work-life harmony",
  ...
  },
  {
    ...
    subtitle: "An awareness program highlighting the psychological impact of cancer and the importance of mental support for patients",
  ...
  },
  {
    ...
    type: "Awareness Program",
    date: "2nd April 2022",
    subtitle: "A community awareness session with Y's Kolkata Chapter breaking myths and building understanding around autism",
